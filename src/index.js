...
client.on('voiceStateUpdate', (oldState, newState) => {
    ...
    if (oldState.channel && !newState.channel) {
        ...
        const logChannel = oldState.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
...
client.on('voiceStateUpdate', (oldState, newState) => {
    ...
    if (!oldState.channel && newState.channel) {
        ...
        const logChannel = newState.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
...
client.on('messageDelete', (message) => {
    ...
    const logChannel = message.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
...
client.on('roleCreate', (role) => {
    ...
    const logChannel = role.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
...
client.on('messageUpdate', (oldMessage, newMessage) => {
    ...
    const logChannel = newMessage.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
...
client.on('guildMemberUpdate', (oldMember, newMember) => {
    ...
    if (addedRole) {
        ...
        const logChannel = newMember.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
...
client.on('inviteCreate', async invite => {
    ...
    const logChannel = invite.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
...
client.on('roleUpdate', (oldRole, newRole) => {
    const logChannel = newRole.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
    if (!logChannel) {
        console.log('Canal audit-log no encontrado');
        return;
    }
...
client.on('emojiCreate', async emoji => {
    const logChannel = emoji.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
    if (!logChannel) {
...
client.on('emojiUpdate', async (oldEmoji, newEmoji) => {
    const logChannel = newEmoji.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
    if (!logChannel) {
        console.error('Canal audit-log no encontrado');
        return;
    }
...
client.on('channelCreate', async channel => {
    const logChannel = channel.guild.channels.cache.find(ch => ch.name === process.env.LOGS_CHANNEL);
    if (!logChannel) {
        console.error('Canal audit-log no encontrado');
        return;
    }
...
client.on('channelUpdate', async (oldChannel, newChannel) => {
    ...
    const logChannel = newChannel.guild.channels.cache.find(ch => ch.name === process.env.LOGS_CHANNEL);
    if (!logChannel) {
        console.error('Canal audit-log no encontrado');
        return;
    }
...
client.on('messageDeleteBulk', async messages => {
    const logChannel = messages.first().guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
    if (!logChannel) {
        console.error('Canal audit-log no encontrado');
        return;
    }
...
client.on('guildMemberAdd', member => {
    const logChannel = member.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
    if (!logChannel) {
        console.error('Canal audit-log no encontrado');
        return;
    }
...
client.on('guildBanRemove', async (ban) => {
    const logChannel = ban.guild.channels.cache.find(channel => channel.name === process.env.LOGS_CHANNEL);
    if (!logChannel) {
        console.error('Canal audit-log no encontrado');
        return;
    }
